...
<head>
    ...
    <?php $this->head() ?>
    <link rel="stylesheet" href="/education/css/offcanvas.css">
...
//        'brandUrl' => Yii::$app->homeUrl,
    ...
    $menuItems = [
        ...
        ['label' => 'Education', 'url' => ['/education/task/index']],
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="padding: 0px;">
...
<div class="container">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <p class="col-md-4 mb-0 text-muted">© <?= date('Y') ?> <?= Html::encode(Yii::$app->name) ?> </p>
