...
<div>
    <p>
        ...
        <ol>
            <li>
                Реализуйте возможность добавлять к контакту несколько дат с выбором типа: день рождения, день
                профессии, день первой встречи (можете дополнить или поменять перечень). Используйте для выбора типа даты элемент &lt;select &gt; .
            </li>
            <li>
                Реализуйте возможность загружать несколько файлов с подписями каждого из них. Содержание подписи не ограничивается ( &lt;textarea&gt; ).
            </li>
            <li>
                Реализуйте возможность удалять добавленные элементы (пп.1-2) каждый по отдельности.
            </li>
            <li>
                Проверьте функциональность формы, убедитесь, что все данные, в т. ч. от добавленных элементов, передаются при отправке формы (попадают в адресную строку браузера).
            </li>
        </ol>
    </p>
    <p>
