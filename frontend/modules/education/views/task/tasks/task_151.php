...
<div class="row g-5">
    <div class="col-md-6">
        ...
        <p>Примеры на проработку и закрепление материла. Реализовать самостоятельно.</p>
        <ul class="icon-list ps-0">
            <li class="d-flex align-items-start mb-1"><a href="<?= Url::to(['/education/task/dz', 'id' => 51]) ?>">
                    DЗ Вставить элемент в центр списка</a></li>
        </ul>
    </div>
